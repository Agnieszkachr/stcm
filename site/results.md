...
The outputs from STCM provide a calibrated, quantitative measurement of the literary relationship among the double-tradition texts: their geometry is consistent with derivation from a common written source, whilst not by itself adjudicating between the Two-Source and Farrer hypotheses.
...
![Centred-cosine distribution vs. permutation null](img/fig1_centred_distribution.png)

![Residual symmetry of the top five pericopes](img/fig2_residual_symmetry.png)

![Full ranking of all 36 pericopes](img/fig3_full_ranking.png)

![Centred cosine vs. passage length](img/fig4_centred_vs_length.png)

![Centred cosine by form-critical category](img/fig5_centred_by_form.png)

![Centred cosine by Kloppenborg stratum](img/fig6_centred_by_stratum.png)
